...
export const VideoGrid: React.FC<VideoGridProps> = ({
  ...
  const { layout, gridColumns, showStats } = useSelector(
  ...
  if (cameras.length === 0) {
    return (
      <EmptyState>
        ...
        <EmptyStateText>
          No cameras are currently active or selected. Add cameras to your
          system or create a test stream to get started.
        </EmptyStateText>
      </EmptyState>
    );
  }
